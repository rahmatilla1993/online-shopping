...
if (isset($_POST['product_name'])) {
    ...
    if ($done) {
        ...
        if ($count != 4) {
            ...
            $query = "INSERT INTO product(product_name,date_of_delivery,validate_date,status,price,photo,prod_count,description,id_category,id_brand) VALUES"
                . "('{$prod_name}','{$date_delivery}','{$date_validate}',{$isActive},{$price},'{$paths}',{$prod_count},'{$description}',{$prod_category},{$prod_brand});";
            if ($mysql->query($query)) {
                $result_query = true;
                $result_string = "Mahsulot qo'shildi!";
            } else {
                $result_string = 'Xatolik';
            }
        }
    }
}
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12" style="margin-left: 23%;">
                            <h3 style="margin-left:20%;">Mahsulot qo'shish</h3>
                            <div class="col-md-6">
                                <?php
                                if ($isPressed) {
                                    if ($result_query) {
                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" action="" method="POST">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input id="available_quantity" name="prod_count" class="form-control input-md" required type="number" min="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input id="available_quantity" name="price" class="form-control input-md" required type="number" min="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input id="tutorial" name="date_delivery" class="form-control input-md" required type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input id="tutorial_fr" name="date_validate" class="form-control input-md" required type="date">
                                        </div>
                                    </div>
