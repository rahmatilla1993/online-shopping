...
if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    if (hasUsername($username)) {
        ...
        if (password_verify($password, $res['password'])) {
            ...
            $res_string = 'Parol xato!';
        }
    } else {
        $res_string = 'Bunday usernameli user topilmadi!';
    }
}
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" name="username" placeholder="Usernameni kiriting..." require>
                                        </div>
                                        <div class="form-group">
